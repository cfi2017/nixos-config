            ...
            programs = {
              ...
              neomutt = {
                ...
                extraConfig = ''
                  ...
                  # Mark read or unread.
                  macro index,pager ,r \
                    "<modify-labels>-unread<enter><sync-mailbox>" \
                    "mark message read"
                  ...
                  # Gmail archive means removing the inbox label. Also mark it read.
                  macro index,pager ,a \
                    "<modify-labels-then-hide>-inbox -unread<enter><sync-mailbox>" \
                    "mark read and archive"

                  # Useful extras.
                  macro index,pager ,s \
                    "<modify-labels>!flagged<enter><sync-mailbox>" \
                    "toggle Gmail star"
